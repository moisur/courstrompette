...
export default function Component() {
  const methods = [
    {
      icon: <FontAwesomeIcon icon={faRocket} className="w-16 h-16 text-orange-700" />,
    ...
    {
      icon: <FontAwesomeIcon icon={faBrain} className="w-16 h-16 text-orange-700" />,
    ...
    {
      icon: <FontAwesomeIcon icon={faUsers} className="w-16 h-16 text-orange-700" />,
    ...
    <section className="py-16 bg-gray-50">
      <div className="container mx-auto px-4">
        <h2 className="text-4xl md:text-5xl font-bold text-center text-gray-800 mb-16">
          Apprendre la trompette à Paris 🎺
        </h2>
