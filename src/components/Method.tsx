  ...
  const methods = [
    {
      ...
      title: "Apprentissage Fulgurant",
      description: "Mon approche unique vous propulse de débutant à musicien accompli en un temps record. Préparez-vous au décollage !"
    },
    {
    ...
    <section className="py-16 bg-gray-50">
      <div className="container mx-auto px-4">
        <h2 className="text-4xl md:text-5xl font-bold text-center text-gray-800 mb-16">
          La méthode JC : Votre Passeport pour l'Excellence en 90 Jours
        </h2>
