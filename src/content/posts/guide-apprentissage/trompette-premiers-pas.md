---
title: "Vos premiers pas à la Trompette"
date: "2023-05-28"
image: "/debutant.webp"
author: "JC Trompette"
slug: "trompette-premiers-pas"
description: "Le guide pour apprendre à jouer vos premières notes et gammes à la trompette."
niveau: "Débutant"
---

<div class="mb-6 rounded-lg overflow-hidden border bg-white shadow-sm">
  <img src="/debutant.webp" alt="Un trompettiste débutant jouant une note" width="500" height="300" class="w-full h-auto" />
</div>
...
<div class="space-y-4">
  <div class="border rounded-lg p-4 bg-gray-50">
    <h3 class="text-xl font-semibold text-orange-600 mb-2">1. Les Notes : La Base du Langage Musical</h3>
  ...
  <div class="border rounded-lg p-4 bg-gray-50">
    <h3 class="text-xl font-semibold text-orange-600 mb-2">2. Les Gammes : Apprendre à Jouer en Suite</h3>
    <p class="text-gray-700 mb-4">
  ...
  <div class="border rounded-lg p-4 bg-gray-50">
    <h3 class="text-xl font-semibold text-orange-600 mb-2">3. Les Premiers Morceaux : Jouer de la Musique !</h3>
    <p class="text-gray-700 mb-4">
