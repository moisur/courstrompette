---
title: "Le lexique de la trompette"
date: "2024-11-22"
image: "/lexique.jpg"
author: "JC Trompette"
slug: "lexique-trompette"
description: "Comprendre le vocabulaire de la trompette : un guide essentiel pour les débutants."
niveau: "Intermédiaire"
---

<div class="mb-6 rounded-lg overflow-hidden border bg-white shadow-sm">
  <img src="/lexique.jpg" alt="Une trompette avec ses différentes parties" width="500" height="300" class="w-full h-auto" />
</div>
...
<h2 class="text-2xl font-bold mb-4 text-orange-600">Les Parties Essentielles de la Trompette</h2>
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
  <div class="border rounded-lg p-4 shadow-sm bg-white">
    ...
    <img src="/embouchure.jpg" alt="Une embouchure de trompette" class="rounded-lg w-full h-auto" />
  </div>
  ...
  <div class="border rounded-lg p-4 shadow-sm bg-white">
    ...
    <img src="/valves.jpg" alt="Les valves d'une trompette" class="rounded-lg w-full h-auto" />
  </div>
  ...
  <div class="border rounded-lg p-4 shadow-sm bg-white">
    ...
    <img src="/corps.jpg" alt="Le corps d'une trompette" class="rounded-lg w-full h-auto" />
  </div>
  ...
  <div class="border rounded-lg p-4 shadow-sm bg-white">
    ...
    <img src="/pavillon.jpg" alt="Le pavillon d'une trompette" class="rounded-lg w-full h-auto" />
  </div>
</div>

<h2 class="text-2xl font-bold mb-4 text-orange-600">Notions Essentielles</h2>
...
<h2 class="text-2xl font-bold mb-4 text-orange-600">Conclusion:</h2>
